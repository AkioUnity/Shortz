...
public class WatchParty0Activity extends Base1Activity {
    ...
    String nameList[] = {"A_Lum007", "BadMamaJama", "DTSugar", "Eric_El90", "ErikaGellar88", "LoreleiGilmore", "M4m4cit4", "norris_f22"};

    int pics[] = {R.drawable.friend_pic1, R.drawable.friend_pic2, R.drawable.friend_pic0, R.drawable.friend_pic3, R.drawable.friend_pic0, R.drawable.friend_pic4, R.drawable.friend_pic5, R.drawable.friend_pic6, R.drawable.friend_pic7, R.drawable.friend_pic8};
